...
add wave -noupdate /tiny_uart_baud_bit_gen_tb/DO_ALL_TEST
add wave -noupdate /tiny_uart_baud_bit_gen_tb/CLKENA_DIV
add wave -noupdate -divider Main
add wave -noupdate /tiny_uart_baud_bit_gen_tb/R
add wave -noupdate /tiny_uart_baud_bit_gen_tb/C
add wave -noupdate /tiny_uart_baud_bit_gen_tb/CENA
...
add wave -noupdate /tiny_uart_baud_bit_gen_tb/DUT/start_i
...
WaveRestoreCursors {{Cursor 1} {7500000 ps} 0}
